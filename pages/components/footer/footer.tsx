  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>Footer Certiblock</title>
          <meta name="description" content="Generated by create next app" />
          <link rel="icon" href="/favicon.ico" />
        </Head>
      </div>

      <div className="flex justify-center w-screen h-max">
        <footer className="footer p-10 bg-base-200 md:rounded-t-[4.5rem] grid-flow-col font-black text-lg text-success">
          <div>
